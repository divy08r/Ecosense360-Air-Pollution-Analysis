...
city_day_csv = 'https://drive.google.com/file/d/126tL-NY-YuHVkhP5MGvqXINUT8neZVmv/view?usp=sharing'
city_day_csv='https://drive.google.com/uc?id=' + city_day_csv.split('/')[-2]

city_hour_csv = 'https://drive.google.com/file/d/1yduOjYW1R1BOudxkR7bFnigfwmr7__kN/view?usp=sharing'
city_hour_csv='https://drive.google.com/uc?id=' + city_hour_csv.split('/')[-2]

station_day_csv = 'https://drive.google.com/file/d/1nEERP6LgHhtbxuHtC4lGI8rQe_z8e0Q-/view?usp=sharing'
station_day_csv='https://drive.google.com/uc?id=' + station_day_csv.split('/')[-2]

station_hour_csv = 'https://drive.google.com/file/d/1qlVjJzpvM7GfnuOXz6hBM3t12evv7Pw9/view?usp=sharing'
station_hour_csv='https://drive.google.com/uc?id=' + station_hour_csv.split('/')[-2]

station_csv = 'https://drive.google.com/file/d/1g8toxFqJ3Fs3xOa4qCidaULuNe5UcbnV/view?usp=sharing'
station_csv='https://drive.google.com/uc?id=' + station_csv.split('/')[-2]


city_day_data = pd.read_csv(city_day_csv)
city_hour_data = pd.read_csv(city_hour_csv)
station_day_data = pd.read_csv(station_day_csv)
station_hour_data = pd.read_csv(station_hour_csv)
