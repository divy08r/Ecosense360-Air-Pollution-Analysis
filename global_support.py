...
global_data_csv='https://drive.google.com/file/d/1dshOdFQ021QkaMl_nP3CaJyxyu3Wgp7N/view?usp=sharing'
global_data_csv='https://drive.google.com/uc?id=' + global_data_csv.split('/')[-2]

global_data = pd.read_csv(global_data_csv)
